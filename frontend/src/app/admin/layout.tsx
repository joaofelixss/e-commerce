...
import Sidebar from "@/features/dashboard/components/Sidebar"; // Assumindo que Sidebar está aqui
import { Menu } from "lucide-react";
import { SidebarProvider, useSidebarContext } from "@/contexts/SidebarContext"; // Assumindo que o contexto está aqui
import { cn } from "@/lib/utils";
import { Button } from "@/components/ui/button";
import { Toaster } from "sonner"; // Importe o Toaster do sonner
...
const AdminLayout: React.FC<AdminLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="flex">
      ...
      <Toaster richColors /> {/* Adicionando o Toaster do sonner */}
    </div>
  );
};

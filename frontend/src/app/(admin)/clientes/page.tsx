...
import {
  getClientes,
  deleteCliente,
} from "@/features/admin/gerenciar-clientes/api/clientes";
import AddClienteModal from "@/features/admin/gerenciar-clientes/components/AddClienteModal";
import EditClienteModal from "@/features/admin/gerenciar-clientes/components/EditClienteModal";
import {
  Dialog,
  DialogContent,
  DialogDescription,
